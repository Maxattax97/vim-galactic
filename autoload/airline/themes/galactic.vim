let g:airline#themes#galactic#palette = {}

function! airline#themes#galactic#refresh()
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Options
  """"""""""""""""""""""""""""""""""""""""""""""""
  let s:background           = get(g:, 'airline_galactic_bg', &background)
  let s:ansi_colors          = get(g:, 'galactic_termcolors', 16) != 256 && &t_Co >= 16 ? 1 : 0
  let s:use_blue             = get(g:, 'airline_galactic_normal_blue', 1)
  let s:dark_text            = get(g:, 'airline_galactic_dark_text', 1)
  ...
  if s:ansi_colors && get(g:, 'galactic_base16', 0)
    ...
    let s:magenta = {'t': 17, 'g': "#fe3bb9"}  " Base 0F
    let s:violet  = {'t': 5,  'g': "#cc62fe"}  " Base 0E
    let s:blue    = {'t': 4,  'g': "#3294ff"}  " Base 0D
    ...
    let s:magenta = {'t': s:ansi_colors ?   5 : (s:tty ? '5' : 125), 'g': '#fe3bb9'}
    let s:violet  = {'t': s:ansi_colors ?  13 : (s:tty ? '5' : 61 ), 'g': '#cc62fe'}
    let s:blue    = {'t': s:ansi_colors ?   4 : (s:tty ? '4' : 33 ), 'g': '#3294ff'}
    let s:cyan    = {'t': s:ansi_colors ?   6 : (s:tty ? '6' : 37 ), 'g': '#07a38f'}
    let s:green   = {'t': s:ansi_colors ?   2 : (s:tty ? '2' : 64 ), 'g': '#4ca340'}
  endif
  ...
  if s:background == 'dark'
    let s:N1 = [(s:dark_text ? s:base03 : s:base3), (s:use_blue ? s:blue : s:base1), 'bold']
    let s:N2 = [s:base2, (s:tty ? s:base01 : s:base00), '']
    let s:N3 = [s:base01, s:base02, '']
  else
    let s:N1 = [(s:dark_text ? s:base03 : s:base2), (s:use_blue ? s:blue : s:base00), 'bold']
  ...
  " Inactive, according to VertSplit in galactic
  ...
  let g:airline#themes#galactic#palette.accents = {
        \ 'red': s:NFa,
        \ }

  let g:airline#themes#galactic#palette.inactive = airline#themes#generate_color_map(
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]])
  let g:airline#themes#galactic#palette.inactive_modified = {
        \ 'airline_c': [s:NMi[0].g, '', s:NMi[0].t, '', s:NMi[2]]}

  let g:airline#themes#galactic#palette.normal = airline#themes#generate_color_map(
        \ [s:N1[0].g, s:N1[1].g, s:N1[0].t, s:N1[1].t, s:N1[2]],
        \ [s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]],
        \ [s:N3[0].g, s:N3[1].g, s:N3[0].t, s:N3[1].t, s:N3[2]])

  let g:airline#themes#galactic#palette.normal.airline_warning = [
  ...
  let g:airline#themes#galactic#palette.normal_modified.airline_warning =
        \ g:airline#themes#galactic#palette.normal.airline_warning

  let g:airline#themes#galactic#palette.insert = airline#themes#generate_color_map(
        \ [s:I1[0].g, s:I1[1].g, s:I1[0].t, s:I1[1].t, s:I1[2]],
        \ [s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]],
        \ [s:I3[0].g, s:I3[1].g, s:I3[0].t, s:I3[1].t, s:I3[2]])

  let g:airline#themes#galactic#palette.insert.airline_warning =
        \ g:airline#themes#galactic#palette.normal.airline_warning

  let g:airline#themes#galactic#palette.insert_modified = {
        \ 'airline_c': [s:IM[0].g, s:IM[1].g,
        \ s:IM[0].t, s:IM[1].t, s:IM[2]]}

  let g:airline#themes#galactic#palette.insert_modified.airline_warning =
        \ g:airline#themes#galactic#palette.normal.airline_warning

  let g:airline#themes#galactic#palette.visual = airline#themes#generate_color_map(
  ...
  let g:airline#themes#galactic#palette.visual.airline_warning =
        \ g:airline#themes#galactic#palette.normal.airline_warning

  let g:airline#themes#galactic#palette.visual_modified = {
        \ 'airline_c': [s:VM[0].g, s:VM[1].g,
        \ s:VM[0].t, s:VM[1].t, s:VM[2]]}

  let g:airline#themes#galactic#palette.visual_modified.airline_warning =
        \ g:airline#themes#galactic#palette.normal.airline_warning

  let g:airline#themes#galactic#palette.replace = airline#themes#generate_color_map(
  ...
  let g:airline#themes#galactic#palette.replace.airline_warning =
        \ g:airline#themes#galactic#palette.normal.airline_warning

  let g:airline#themes#galactic#palette.replace_modified = {
        \ 'airline_c': [s:RM[0].g, s:RM[1].g,
        \ s:RM[0].t, s:RM[1].t, s:RM[2]]}

  let g:airline#themes#galactic#palette.replace_modified.airline_warning =
        \ g:airline#themes#galactic#palette.normal.airline_warning

  let g:airline#themes#galactic#palette.tabline = {}

  let g:airline#themes#galactic#palette.tabline.airline_tab = [
        \ s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]]

  let g:airline#themes#galactic#palette.tabline.airline_tabtype = [
        \ s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]]
endfunction

call airline#themes#galactic#refresh()
